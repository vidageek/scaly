...
libraryDependencies ++= Seq("junit" % "junit" % "4.10", 
							...
							"log4j" % "log4j" % "1.2.16",
							"org.eclipse.jetty" % "jetty-webapp" % "7.4.5.v20110725" % "provided",
      						"org.eclipse.jetty" % "jetty-servlets" % "7.4.5.v20110725" % "provided",
      						"org.eclipse.jetty" % "jetty-jsp-2.1" % "7.4.5.v20110725" % "provided",
      						"org.mortbay.jetty" % "jsp-2.1-glassfish" % "2.1.v20100127" % "provided",
